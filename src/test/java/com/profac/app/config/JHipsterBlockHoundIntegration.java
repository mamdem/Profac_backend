...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.profac.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.profac.app.security.DomainUserDetailsService", "createSpringSecurityUser");
